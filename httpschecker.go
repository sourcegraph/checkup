...
type HTTPSChecker struct {
	...
	// requests. If not set, DefaultHTTPSClient is
	// used.
...
func (c HTTPSChecker) doChecks(req *http.Request) Attempts {
...
func (c HTTPSChecker) conclude(result Result) Result {
...
func (c HTTPSChecker) checkDown(resp *http.Response) error {
	// Check status code
